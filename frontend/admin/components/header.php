<?php
// Définir les noms de page en fonction du fichier actuel
$currentPage = basename($_SERVER['PHP_SELF']);

// Tableau associatif des noms de page correspondants
$pageTitles = array(
    'index.php' => 'Accueil',
    'New.php' => 'New House',
    'Tags.php' => "New Tag",
...
// Récupérer le titre actuel de la page
$currentTitle = isset($pageTitles[$currentPage]) ? $pageTitles[$currentPage] : 'Titre par défaut';
...
<header class="header header-sticky mb-4">
    <div class="container-fluid">
        ...
        <ul class="header-nav d-none d-md-flex">
            <li class="nav-item"><a class="nav-link" href="New.php">Ajouter</a></li>
            ...
            <li class="nav-item"><a class="nav-link" href="#">Villes & Quartier</a></li>
        </ul>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link py-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true"
                    ...
                    <div class="avatar avatar-md">
                        <img class="avatar-img" src="<?= $_SESSION['photo'] ?>" alt="<?= $_SESSION['firstname'] ?>">
                    </div>
                </a>
